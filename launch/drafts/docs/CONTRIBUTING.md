...
1. **No cross-module implementation imports.** A business module must never
   ...
   struct. See [add-a-module.md](add-a-module.md) for the pattern.
...
See also: [add-a-module.md](add-a-module.md) for the module pattern reviewers
expect, [architecture.md](architecture.md) for why the port boundary exists.
